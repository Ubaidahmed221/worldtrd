...
<div class="main_content_iner ">
    ...
    <div class="card-body">
    <form action="{{url('/')}}/dashboard/store-plan-categories" method="POST" enctype="multipart/form-data">
        @csrf
    <div class="row mb-3">
    <div class="col-md-6">
    ...
    <input type="file" class="form-control" name="img"  placeholder="Category image">
    @error('img')
        <p class="text-danger">{{$message}}</p>
    @enderror
    </div>
