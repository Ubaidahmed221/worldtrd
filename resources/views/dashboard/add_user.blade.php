...
<div class="main_content_iner ">
    ...
    <input type="text" class="form-control" id="inputEmail4" placeholder="Enter Full name">
    </div>
    <div class=" col-md-6">
    ...
    <div class=" col-md-4">
        ...
        <input type="text" class="form-control" id="inputPassword4" placeholder="Email or username">
    </div>
    <div class=" col-md-4">
