...
<div class="main_content_iner ">
    ...
    <div class="card-body">
    <form action="{{url('/')}}/dashboard/update-withdraw/{{$data->withdraw_id}}" method="POST">
        @csrf
    <div class="row mb-3">
    
    <div class=" col-md-6">
    <label class="form-label" for="inputPassword4">Final amount in $</label>
    <input type="text" name="final_amount" readonly value="{{$data->final_amount}}" class="form-control" id="inputPassword4" placeholder="Enter final amount">
    </div>
    <div class="col-md-6">
...
<div class="row mb-3">
    ...
    <div class=" col-md-6">
        <label class="form-label" for="inputAddress">Account Number</label>
        <input type="text" name="account_number" value="{{$data->account_number}}" class="form-control"
            placeholder="Account Number" id="inputDate">
    </div>
    <div class=" col-md-6">
