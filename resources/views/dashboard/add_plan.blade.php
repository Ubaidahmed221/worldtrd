                ...
                <div class="col-lg-12">
                    <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body">
                            <div class="card-body">
                                <form action="{{url('/dashboard/store-plan')}}"  method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                        ...
                                        <div class=" col-md-4">
                                            <label class="form-label">Minimum plan amount (in $)</label>
                                    ...
                                    <div class="row mb-3">
                                        <div class=" col-md-4">
                                            <label class="form-label">Maximum plan amount (in $)</label>
                                            <input type="number" name="maxamount" step="0.01" value="{{ old('maxamount') }}"
                                                class="form-control" placeholder="Maximum plan amount">
                                            @error('maxamount')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
